                ...
                state.convertedImages.forEach((image, index) => {
                    ...
                    card.innerHTML = `
                        ...
                        <div class="w-full h-48 flex items-center justify-center p-2 bg-slate-100 dark:bg-slate-700">
                           <img src="${image.data}" alt="Preview for Page JPG ${image.pageNum}" class="max-w-full max-h-full object-contain">
                        </div>
        ...
        async function processPDF() {
            ...
            try {
                ...
                for (let i = 1; i <= numPages; i++) {
                    ...
                    state.convertedImages.push({ pageNum: i, data: canvas.toDataURL("image/jpeg", 0.92) });
                }
        ...
        async function downloadZip() {
            ...
            try {
                ...
                for (let i = 0; i < totalFiles; i++) {
                    ...
                    zip.file(`Page_${image.pageNum}.jpg`, base64Data, { base64: true });
