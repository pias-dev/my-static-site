document.addEventListener('DOMContentLoaded', () => {
    ...
    const errorMessage = document.getElementById('title-error'); // Reusing title-error for messages
    ...
    function buildEventData() {
        ...
        return fields.filter(field => field.split(':')[1].trim()).join('\n');
    }
    ...
    const initiateDownload = (format) => {
        ...
        try {
            ...
            new QRCode(tempContainer, { text: eventData, width: highRes, height: highRes, colorDark: fgColor, colorLight: bgColor, correctLevel: QRCode.CorrectLevel.H });
