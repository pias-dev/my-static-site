...
`;class Footer extends HTMLElement{constructor(){super()}connectedCallback(){this.innerHTML=footerHTML;const e=this.querySelector("#year");e&&(e.textContent=(new Date).getFullYear())}}customElements.define("footer-component",Footer);