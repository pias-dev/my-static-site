    ...
    <div class="max-w-screen-xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2 list-disc pl-5 text-slate-800 text-base font-semibold dark:text-slate-300">
                    <li><a href="image/image-tools" class="hover:text-purple-600 dark:hover:text-purple-400">Image Tools</a></li>
            ...
            <!-- Tools -->
            <div>
                <h2 class="text-indigo-600 dark:text-indigo-400 text-lg font-bold underline mb-4 underline-offset-8">Tools</h2>
                <ul class="mt-4 space-y-2 list-disc pl-5 text-slate-800 text-base font-semibold dark:text-slate-300">
