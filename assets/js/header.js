document.addEventListener("DOMContentLoaded", function() {
    const headerHTML = `
    <header class="fixed top-0 z-50 w-full bg-white/80 backdrop-blur-sm shadow-md transition-colors duration-300 border-b border-indigo-300 dark:border-slate-700 dark:bg-slate-900/80 dark:shadow-slate-800">
        <div class="px-4 sm:px-6 mx-auto">
            <div class="flex items-center justify-between h-16">
                ...
                <nav class="hidden md:flex items-center space-x-8 text-lg font-semibold text-slate-800 dark:text-slate-200">
                    <a href="index.html" class="nav-link-animated hover:text-purple-600 dark:hover:text-purple-400">Home</a>
                    <a href="#main-tools" class="nav-link-animated hover:text-purple-600 dark:hover:text-purple-400">Tools List</a>
                    <a href="#" class="nav-link-animated hover:text-purple-600 dark:hover:text-purple-400">About</a>
                    <a href="#" class="nav-link-animated hover:text-purple-600 dark:hover:text-purple-400">Contact</a>
        ...
        <div id="mobile-menu" class="lg:hidden hidden">
            <div class="p-2 text-base font-medium text-slate-700 dark:text-slate-300">
                <a href="index.html" class="block p-2 mt-1 hover:bg-slate-100 dark:hover:bg-slate-700">Home</a>
                <a href="#main-tools" class="block p-2 mt-1 hover:bg-slate-100 dark:hover:bg-slate-700">Tools List</a>
                <a href="#" class="block p-2 mt-1 hover:bg-slate-100 dark:hover:bg-slate-700">About</a>
                <a href="#" class="block p-2 mt-1 hover:bg-slate-100 dark:hover:bg-slate-700">Contact</a>
                <a href="#" aria-label="Get our app on Google Play" title="Google Play" class="flex items-center p-2 mt-1 hover:bg-slate-100 dark:hover:bg-slate-700"><span class="sr-only">Google Play</span><img src="./assets/svg/play.svg" alt="Google Play Icon" class="w-6 h-6"><span class="ml-2">Google Play</span></a>
            </div>
        </div>
    </header>
    `;
