    ...
    <header class="fixed top-0 z-50 w-full bg-white backdrop-blur-sm transition-colors duration-300 border-b border-indigo-300 dark:border-slate-700 dark:bg-slate-800">
        ...
        <div id="mobile-menu" class="lg:hidden hidden">
            <div class="p-2 text-base font-medium text-slate-700 dark:text-slate-300">
                ...
                <a href="https://play.google.com/store/" aria-label="Get our app on Google Play" title="Google Play" class="flex items-center p-2 mt-1 hover:bg-slate-100 dark:hover:bg-slate-700"><span class="sr-only">Google Play</span><img src="./assets/svg/play.svg" alt="Google Play Icon" class="w-6 h-6"><span class="ml-2">Google Play</span></a>
            </div>
        </div>
    </header>
    `;
