        ...
        <div class="px-4 sm:px-6">
            <div class="flex items-center justify-between h-16">
                ...
                <nav class="hidden md:flex items-center space-x-8">
                    <a href="index.html" class="nav-link-animated text-lg font-semibold text-slate-600 hover:text-purple-600 focus:text-purple-600 active:text-purple-600 dark:text-slate-300 dark:hover:text-purple-400 dark:focus:text-purple-400 dark:active:text-purple-400">Home</a>
