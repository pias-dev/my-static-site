    ...
    <header class="fixed top-0 z-50 w-full bg-white/80 backdrop-blur-sm shadow-md transition-colors duration-300 dark:bg-slate-900/80 dark:shadow-slate-800">
        <div class="px-4 sm:px-6">
            <div class="flex items-center justify-between h-16">
                ...
                <nav class="hidden md:flex items-center space-x-8 text-lg font-semibold text-slate-600 dark:text-slate-300">
        ...
        <div id="mobile-menu" class="lg:hidden hidden">
            <div class="p-2 text-base font-medium text-slate-700 dark:text-slate-300">
                ...
                <a href="#" aria-label="Get our app on Google Play" title="Google Play" class="flex items-center p-2 hover:bg-slate-100 dark:hover:bg-slate-700"><span class="sr-only">Google Play</span><img src="./src/icon-google-play.svg" alt="Google Play Icon" class="w-6 h-6"><span class="ml-2">Google Play</span></a>
            </div>
        </div>
    </header>
    `;
