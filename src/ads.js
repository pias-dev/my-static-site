...
function loadAds() {
    ...
    showAd('top-ad-container-mobile', topAdScriptMobile);
    showAd('top-ad-container-tablet', topAdScriptTablet);
    showAd('top-ad-container-desktop', topAdScriptDesktop);

    showAd('sidebar-ad-container-1', sidebarAdScript);
    showAd('sidebar-ad-container-2', sidebarAdScript);

    showAd('bottom-ad-container-mobile', bottomAdScriptMobile);
    showAd('bottom-ad-container-tablet', bottomAdScriptTablet);
