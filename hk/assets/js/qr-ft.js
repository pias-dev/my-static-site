    ...
    <div class="max-w-screen-xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2 list-disc pl-5 text-slate-800 text-lg font-semibold dark:text-slate-300">
                    <li><a href="/qrcode-scan" class="color-link1 hover:text-purple-600 dark:hover:text-purple-400">Qrcode Scan</a></li>
                    ...
                    <li><a href="/link-qr-code-generator" class="color-link4 hover:text-purple-600 dark:hover:text-purple-400">Link QR Code Generator</a></li>
                    ...
                    <li><a href="/phonenumber-qr-code-generator" class="color-link6 hover:text-purple-600 dark:hover:text-purple-400">PhoneNumber QR Code Generator</a></li>
