        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2 list-disc pl-5 text-slate-800 text-lg font-semibold dark:text-slate-300">
                    ...
                    <li><a href="/pdf-page-delete" class="color-link11 hover:text-purple-600 dark:hover:text-purple-400">PDF Page Delete</a></li>
                    ...
                    <li><a href="/watermark-to-pdf" class="color-link13 hover:text-purple-600 dark:hover:text-purple-400">Watermark to PDF</a></li>
