        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2 list-disc pl-5 text-slate-800 text-lg font-semibold dark:text-slate-300">
                    ...
                    <li><a href="/text-to-html" class="color-link2 hover:text-purple-600 dark:hover:text-purple-400">Text to HTML</a></li>
                    <li><a href="/text-to-code-code-to-text" class="color-link3 hover:text-purple-600 dark:hover:text-purple-400">Text to Code & Code to Text</a></li>
